...
fn test_device_display() {
    assert_eq!(format!("{}", Device::Bot), "bot");
    assert_eq!(format!("{}", Device::Mobile), "mobile");
    assert_eq!(format!("{}", Device::Tablet), "tablet");
    assert_eq!(format!("{}", Device::Desktop), "desktop");
    assert_eq!(format!("{}", Device::Other), "other");
}
