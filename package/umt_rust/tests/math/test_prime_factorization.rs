...
fn test_prime_factorization_single_prime() {
    ...
    assert_eq!(result, vec![PrimeFactor { number: 2, count: 3 }]);
}

#[test]
fn test_prime_factorization_27() {
    let result = umt_prime_factorization(27);
    assert_eq!(result, vec![PrimeFactor { number: 3, count: 3 }]);
}
...
fn test_prime_factorization_prime_number() {
    ...
    assert_eq!(result, vec![PrimeFactor { number: 2, count: 1 }]);
}
...
fn test_prime_factorization_998() {
    ...
    assert_eq!(result, vec![
        PrimeFactor { number: 2, count: 1 },
        PrimeFactor { number: 499, count: 1 }
    ]);
}
