//! Tests for min value validation

use umt_rust::validate::number::umt_min_value;

#[test]
fn test_min_value_returns_true_for_numbers_greater_than_or_equal_to_min() {
...
#[test]
fn test_min_value_returns_false_for_numbers_less_than_min() {
    let validator = umt_min_value(10.0, None);
    assert!(!(validator.validate)(&9.0));
}

#[test]
fn test_min_value_returns_custom_message() {
...
#[test]
fn test_min_value_with_negative_numbers() {
    let validator = umt_min_value(-5.0, None);
...
#[test]
fn test_min_value_with_decimal_numbers() {
    let validator = umt_min_value(5.5, None);
