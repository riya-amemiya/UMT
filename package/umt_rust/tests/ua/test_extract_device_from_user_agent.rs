use umt_rust::ua::{umt_extract_device_from_user_agent, Device};
...
fn test_should_detect_mobile_devices() {
    ...
    assert_eq!(
        umt_extract_device_from_user_agent(iphone),
        Device::Mobile
    );
    assert_eq!(
...
fn test_should_detect_desktop_devices() {
    ...
    assert_eq!(
        umt_extract_device_from_user_agent(windows),
        Device::Desktop
    );
