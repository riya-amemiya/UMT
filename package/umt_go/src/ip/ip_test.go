...
func TestIpToBinaryString(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.ip, func(t *testing.T) {
			result, err := IpToBinaryString(tt.ip)
			if err != nil {
				t.Fatalf("unexpected error: %v", err)
			}
			if result != tt.expected {
				t.Errorf("IpToBinaryString(%q) = %q, want %q", tt.ip, result, tt.expected)
			}
		})
	}
}
...
func TestIpToBinaryStringInvalid(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.ip, func(t *testing.T) {
			_, err := IpToBinaryString(tt.ip)
			if err == nil {
				t.Fatalf("expected error for %q, got nil", tt.ip)
			}
...
func TestIpToBinaryStringLeadingZeros(t *testing.T) {
	...
	for _, ip := range invalids {
		t.Run(ip, func(t *testing.T) {
			_, err := IpToBinaryString(ip)
			if err == nil {
				t.Fatalf("expected error for %q, got nil", ip)
			}
...
func TestIpToLong(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.ip, func(t *testing.T) {
			result, err := IpToLong(tt.ip)
			if err != nil {
				t.Fatalf("unexpected error: %v", err)
			}
			if result != tt.expected {
				t.Errorf("IpToLong(%q) = %d, want %d", tt.ip, result, tt.expected)
			}
		})
	}
}
...
func TestLongToIpInvalid(t *testing.T) {
	...
	for _, v := range tests {
		t.Run(fmt.Sprintf("%d", v), func(t *testing.T) {
			assertPanic(t, func() { LongToIp(v) }, "Input must be a valid 32-bit unsigned integer")
		})
	}
}
...
func TestCidrToSubnetMask(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(fmt.Sprintf("/%d", tt.cidr), func(t *testing.T) {
			result := CidrToSubnetMask(tt.cidr)
			if result != tt.expected {
...
func TestCidrToSubnetMaskInvalid(t *testing.T) {
	...
	for _, cidr := range tests {
		t.Run(fmt.Sprintf("%d", cidr), func(t *testing.T) {
			assertPanic(t, func() { CidrToSubnetMask(cidr) }, "CIDR must be an integer between 0 and 32")
		})
	}
}
...
func TestSubnetMaskToCidr(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.mask, func(t *testing.T) {
			result, err := SubnetMaskToCidr(tt.mask)
			if err != nil {
				t.Fatalf("unexpected error: %v", err)
			}
			if result != tt.expected {
...
func TestSubnetMaskToCidrInvalid(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.mask, func(t *testing.T) {
			_, err := SubnetMaskToCidr(tt.mask)
			if err == nil {
...
func TestGetNetworkAddress(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.ip+"_"+tt.mask, func(t *testing.T) {
			result, err := GetNetworkAddress(tt.ip, tt.mask)
			if err != nil {
				t.Fatalf("unexpected error: %v", err)
			}
			if result != tt.expected {
				t.Errorf("GetNetworkAddress(%q, %q) = %q, want %q", tt.ip, tt.mask, result, tt.expected)
			}
		})
	}
}
...
func TestGetNetworkAddressInvalid(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.ip+"_"+tt.mask, func(t *testing.T) {
			_, err := GetNetworkAddress(tt.ip, tt.mask)
			if err == nil {
				t.Fatalf("expected error for ip=%q mask=%q, got nil", tt.ip, tt.mask)
			}
			if !strings.Contains(err.Error(), tt.errContains) {
				t.Errorf("expected error containing %q, got %q", tt.errContains, err.Error())
			}
...
func TestGetIpClass(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.ip, func(t *testing.T) {
			...
			if result != tt.expected {
				t.Errorf("GetIpClass(%q) = %q, want %q", tt.ip, result, tt.expected)
			}
		})
	}
}
...
func TestGetIpClassInvalid(t *testing.T) {
	...
	for _, ip := range invalids {
		t.Run(ip, func(t *testing.T) {
			result, _ := GetIpClass(ip)
			if result != "" {
				t.Errorf("GetIpClass(%q) = %q, want empty string", ip, result)
			}
		})
	}
}
...
func TestIsInRange(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(fmt.Sprintf("%s_in_%s", tt.remoteIp, cidrStr), func(t *testing.T) {
			result, err := IsInRange(tt.remoteIp, cidrStr)
			if err != nil {
				t.Fatalf("unexpected error: %v", err)
			}
			if result != tt.expected {
...
func TestIsInRangeBoundary(t *testing.T) {
	result, err := IsInRange("192.168.1.1", "0.0.0.0/0")
	if err != nil || !result {
		t.Errorf("CIDR 0: expected true, got %v err=%v", result, err)
	}
	result, err = IsInRange("192.168.1.0", "192.168.1.0/32")
	if err != nil || !result {
		t.Errorf("CIDR 32 exact: expected true, got %v err=%v", result, err)
	}
	result, err = IsInRange("192.168.1.1", "192.168.1.0/31")
	if err != nil || !result {
		t.Errorf("CIDR 31: expected true, got %v err=%v", result, err)
	}
	result, err = IsInRange("192.168.1.1", "192.168.1.0/1")
	if err != nil || !result {
...
func TestIsInRangeEdgeCases(t *testing.T) {
	r, _ := IsInRange("192.168.1.5", "192.168.1.0/24")
	if !r {
		t.Error("expected true for 192.168.1.5 in /24")
	}
	r, _ = IsInRange("192.168.2.0", "192.168.1.0/24")
	if r {
		t.Error("expected false for 192.168.2.0 in /24")
	}
	r, _ = IsInRange("192.168.1.0", "192.168.1.0/31")
	if !r {
		t.Error("expected true for .0 in /31")
	}
	r, _ = IsInRange("192.168.1.1", "192.168.1.0/31")
	if !r {
		t.Error("expected true for .1 in /31")
	}
	r, _ = IsInRange("192.168.1.2", "192.168.1.0/31")
	if r {
		t.Error("expected false for .2 in /31")
	}
	r, _ = IsInRange("192.168.1.3", "192.168.1.0/30")
	if !r {
		t.Error("expected true for .3 in /30")
	}
	r, _ = IsInRange("192.168.1.4", "192.168.1.4/30")
	if !r {
...
func TestIsInRangeInvalidInputs(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.remoteIp+"_"+tt.cidr, func(t *testing.T) {
			_, err := IsInRange(tt.remoteIp, tt.cidr)
			if err == nil {
...
func TestIsInRangeErrorMessageFormatting(t *testing.T) {
	_, err := IsInRange("invalid-ip", "192.168.1.0/24")
	if err == nil {
	...
	_, err = IsInRange("192.168.1.1", "invalid-network/24")
	if err == nil {
		t.Fatal("expected error")
	}
	if !strings.Contains(err.Error(), "Invalid IP address format") {
	...
	_, err = IsInRange("999.999.999.999", "192.168.1.0/24")
	if err == nil {
		t.Fatal("expected error")
	}
	if !strings.Contains(err.Error(), "Invalid IP address format") {
...
func TestIsPrivateIpInvalid(t *testing.T) {
	...
	for _, ip := range invalids {
		t.Run(ip, func(t *testing.T) {
			if IsPrivateIp(ip) {
				t.Errorf("IsPrivateIp(%q) = true, want false for invalid input", ip)
			}
		})
	}
}
...
func TestRoundTripIpLong(t *testing.T) {
	...
	for _, ip := range ips {
		longVal, err := IpToLong(ip)
		if err != nil {
			t.Fatalf("IpToLong(%q) error: %v", ip, err)
		}
		converted := LongToIp(longVal)
		if converted != ip {
			t.Errorf("round-trip failed: %q -> %d -> %q", ip, longVal, converted)
		}
	}
}
...
func TestRoundTripCidrSubnetMask(t *testing.T) {
	...
	for _, cidr := range cidrs {
		...
		result, err := SubnetMaskToCidr(mask)
		if err != nil {
...
func TestIntegrationNetworkCalculations(t *testing.T) {
	...
	for _, tc := range testCases {
		binaryStr, err := IpToBinaryString(tc.ip)
		if err != nil {
		...
		_, err = GetNetworkAddress(tc.ip, tc.subnet)
		if err != nil {
			t.Fatalf("GetNetworkAddress error: %v", err)
		}

		convertedSubnet := CidrToSubnetMask(tc.cidr)
		...
		inRange, err := IsInRange(tc.ip, cidrStr)
		if err != nil {
			t.Fatalf("IsInRange error: %v", err)
		}
		if !inRange {
			t.Errorf("%s should be in range %s", tc.ip, cidrStr)
		}
	}
}
...
func TestIntegrationPrivateIpClasses(t *testing.T) {
	...
	for _, tt := range tests {
		if IsPrivateIp(tt.ip) != tt.isPrivate {
			t.Errorf("IsPrivateIp(%q) = %v, want %v", tt.ip, !tt.isPrivate, tt.isPrivate)
		}
		class, _ := GetIpClass(tt.ip)
		if class != tt.class {
			t.Errorf("GetIpClass(%q) = %q, want %q", tt.ip, class, tt.class)
		}
		longVal, _ := IpToLong(tt.ip)
		convertedIp := LongToIp(longVal)
		if IsPrivateIp(convertedIp) != tt.isPrivate {
			t.Errorf("round-trip IsPrivateIp(%q) mismatch", convertedIp)
		}
		convertedClass, _ := GetIpClass(convertedIp)
...
func TestIntegrationComplexNetworkRanges(t *testing.T) {
	...
	for _, tt := range tests {
		subnetMask := CidrToSubnetMask(tt.cidr)
		convertedCidr, err := SubnetMaskToCidr(subnetMask)
		if err != nil {
			t.Fatal(err)
		}
		...
		for _, ipTest := range tt.testIps {
			...
			result, err := IsInRange(ipTest.ip, cidrStr)
			if err != nil {
				t.Fatal(err)
			}
			if result != ipTest.inRange {
				t.Errorf("IsInRange(%q, %q) = %v, want %v", ipTest.ip, cidrStr, result, ipTest.inRange)
			}

			networkIp, err := GetNetworkAddress(tt.network, subnetMask)
			if err != nil {
				t.Fatal(err)
			}
			cidrStr2 := fmt.Sprintf("%s/%d", networkIp, tt.cidr)
			result2, err := IsInRange(ipTest.ip, cidrStr2)
			if err != nil {
				t.Fatal(err)
			}
			if result2 != ipTest.inRange {
				t.Errorf("IsInRange(%q, %q) = %v, want %v", ipTest.ip, cidrStr2, result2, ipTest.inRange)
			}
		}
	}
}
...
func TestIntegrationBinaryConversions(t *testing.T) {
	...
	for _, tt := range tests {
		binaryStr, err := IpToBinaryString(tt.ip)
		if err != nil {
			t.Fatal(err)
		}
		if binaryStr != tt.expectedBinary {
			t.Errorf("IpToBinaryString(%q) = %q, want %q", tt.ip, binaryStr, tt.expectedBinary)
		}

		longVal, err := IpToLong(tt.ip)
		if err != nil {
			t.Fatal(err)
		}
		...
		ipFromLong := LongToIp(longVal)
		if ipFromLong != tt.ip {
			t.Errorf("LongToIp(%d) = %q, want %q", longVal, ipFromLong, tt.ip)
		}
	}
}
...
func TestIntegrationSubnetCalculations(t *testing.T) {
	...
	for _, s := range subnets {
		...
		networkIp, err := GetNetworkAddress(s.network, mask)
		if err != nil {
			t.Fatal(err)
		}

		cidrStr := fmt.Sprintf("%s/%d", networkIp, s.cidr)
		inRange, err := IsInRange(s.network, cidrStr)
		if err != nil {
			t.Fatal(err)
		}
		if !inRange {
		...
		binaryNetwork, err := IpToBinaryString(networkIp)
		if err != nil {
			t.Fatal(err)
		}
		binaryMask, err := IpToBinaryString(mask)
		if err != nil {
			t.Fatal(err)
		}
...
func TestIntegrationEdgeCases(t *testing.T) {
	...
	for _, tt := range tests {
		...
		binary, err := IpToBinaryString(tt.ip)
		if err != nil {
			t.Fatal(err)
		}
		reconstructed := LongToIp(longVal)
		if reconstructed != tt.ip {
			t.Errorf("reconstructed %q, want %q", reconstructed, tt.ip)
		}

		class, _ := GetIpClass(reconstructed)
		if class != tt.class {
			t.Errorf("GetIpClass(%q) = %q, want %q", reconstructed, class, tt.class)
		}
		if IsPrivateIp(reconstructed) != tt.isPrivate {
